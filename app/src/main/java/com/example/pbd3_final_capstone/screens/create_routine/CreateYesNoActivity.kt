...
class CreateYesNoActivity : AppCompatActivity(), CreateRoutineContract.View {
    ...
    private fun setupListeners() {
        ...
        btnFrequency.setOnClickListener {
            ...
            val radios = listOf<RadioButton>(
                dialogView.findViewById(R.id.radio_every_day),
                dialogView.findViewById(R.id.radio_every_x_days),
                dialogView.findViewById(R.id.radio_times_per_week),
                dialogView.findViewById(R.id.radio_times_per_month),
                dialogView.findViewById(R.id.radio_times_in_days)
            )
            ...
            dialogView.findViewById<TextView>(R.id.btn_save).setOnClickListener {
                when {
                    radios[0].isChecked -> presenter.setFrequencyYesNo("daily", 1, 1)
                    radios[1].isChecked -> presenter.setFrequencyYesNo("every_x_days", dialogView.findViewById<EditText>(R.id.edit_every_x_days).text.toString().toIntOrNull() ?: 3, 1)
                    radios[2].isChecked -> presenter.setFrequencyYesNo("times_per_week", dialogView.findViewById<EditText>(R.id.edit_times_per_week).text.toString().toIntOrNull() ?: 3, 1)
                    radios[3].isChecked -> presenter.setFrequencyYesNo("times_per_month", dialogView.findViewById<EditText>(R.id.edit_times_per_month).text.toString().toIntOrNull() ?: 10, 1)
                    radios[4].isChecked -> presenter.setFrequencyYesNo("times_in_days", dialogView.findViewById<EditText>(R.id.edit_times_in_days_x).text.toString().toIntOrNull() ?: 3, dialogView.findViewById<EditText>(R.id.edit_times_in_days_y).text.toString().toIntOrNull() ?: 10)
                }
                dialog.dismiss()
            }
            dialog.show()
